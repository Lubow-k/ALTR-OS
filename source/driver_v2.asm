...
error_message:
    inc bx                     ; bx -> aka counter for 3 loop
    cmp bx, 0x4                ; if we read disk more than 3 times -> problems with disk
    jz end                     ; If problems with disk --> start counting sum to see error
